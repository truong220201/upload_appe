  ...
  render() {
    ...
    return (
      <ImageBackground
        ...
        source={{
          uri: "https://png.pngtree.com/png-vector/20191109/ourlarge/pngtree-abc-blocks-basic-alphabet-knowledge-flat-color-icon-vector-png-image_1968303.jpg",
        }}
      >
        <LinearGradient
          ...
          <View style={styles.vw2}>
            ...
            <Animatable.Text animation={tsp} style={{ width: windowWidth }}>
              <View style={{ width: windowWidth }}>
                <TouchableOpacity
                  onPress={() => {
                    navigation.navigate("speechword");
                  }}
                  style={styles.btnInfo}
                >
                  <View

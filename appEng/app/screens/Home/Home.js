...
export default class Home extends React.Component {
  ...
  async listenForItems(itemRef) {
    ...
    const querySnapshot = await getDocs(
      collection(db, "Category_Dang_Kien_Thuc")
    );
    querySnapshot.forEach((doc) => {
      ...
      this.setState({
        ...
        item: [
          ...this.state.item,
          `${doc.data().Name.slice(4).split("_").join("")}`,
        ],
  ...
  render() {
    ...
    return (
      <LinearGradient
        ...
        colors={["#aef6d6a6", "#ffffff", "#ffffff", "#aef6d6a6"]}
        ...
        <View style={{ width: windowWidth, flex: 1, alignItems: "center" }}>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <Image
                    ...
                    source={{
                      uri: "https://www.iconsdb.com/icons/preview/green/user-4-xxl.png",
                    }}
                  />
                </View>
                <View
              ...
              >
                <TouchableOpacity
                  onPress={() => navigation.navigate("learnspeech")}
                  style={{
                    flexDirection: "column",
                    justifyContent: "center",
                    alignItems: "center",
              ...
              >
                ...
                >
                  <Image
                    ...
                    source={{
                      uri: "https://scontent.fhan5-9.fna.fbcdn.net/v/t39.30808-6/283705731_763859411658694_971246722580644252_n.jpg?_nc_cat=109&ccb=1-7&_nc_sid=5cd70e&_nc_ohc=BjBlsdeHI10AX8HS4n4&tn=nHQac_V4HpyKU2Pt&_nc_ht=scontent.fhan5-9.fna&oh=00_AT8HpAWD3SvL1ipz4fl5dxnzxY9zPskG4Hrpuurr-eF0-Q&oe=629B3094",
                    }}
                  />
                </View>
              </View>
          ...
          {this.state.isLoading ? (
            ...
            >
              <Text>Đang nạp dữ liệu, bạn chờ xíu nhé...</Text>
                        ...
                        return (
                          ...
                          >
                            <TouchableOpacity
                              key={n}
                              onPress={() =>
                                navigation.navigate("luachon", {
                                  loaiId: 1,
                                  ten: this.state.item[n],
                                  id: this.state.keys[n],
                                  uid: this.uid,
                                  email: this.email,
                                })
                              }
                              ...
                              >
                                <View>
                                  <Image
                                    style={styles.circle}
                                    source={{
                                      uri: "https://cdn-icons-png.flaticon.com/512/1903/1903162.png",
                                    }}
                                ...
                                >
                                  <View>
                                    <Image
                                      style={styles.circle}
                                      source={{
                                        uri: "https://cdn-icons-png.flaticon.com/512/201/201612.png",
                                      }}
                                      //onLoadEnd={ ()=>{ console.log('load xong') }}
                                    />
                                  </View>
                                ...
                                >
                                  <View>
                                    <Image
                                      style={styles.circle}
                                      source={{
                                        uri: "https://cdn-icons-png.flaticon.com/512/4072/4072307.png",
                                      }}
                                      //onLoadEnd={ ()=>{ console.log('load xong') }}
                                    />
                                  </View>
